...
!function(e) {
    ...
    M.extend(e.prototype, {
        ...
        _autoSize: function(e) {
            ...
            (r = this._get(e, "dateFormat")).match(/[DM]/) && (t = function(e) {
        ...
        _checkOffset: function(e, t, a) {
            ...
            t.top -= Math.min(t.top, t.top + s > o && s < o ? Math.abs(s + r) : 0),
            t
        },
        _findPos: function(e) {
        ...
        parseDate: function(t, s, e) {
            ...
            function i(e, t, a) {
                ...
                if (M.each(t, function(e, t) {
                    var a = t[1];
                    if (s.substr(c, a.length).toLowerCase() === a.toLowerCase())
                        return i = t[0],
                        c += a.length,
                        !1
                }),
            ...
            function n() {
                if (s.charAt(c) !== t.charAt(v))
                    throw "Unexpected literal at position " + c;
                c++
            }
            for (var r, d, o, c = 0, l = (e ? e.shortYearCutoff : null) || this._defaults.shortYearCutoff, l = "string" != typeof l ? l : (new Date).getFullYear() % 100 + parseInt(l, 10), h = (e ? e.dayNamesShort : null) || this._defaults.dayNamesShort, u = (e ? e.dayNames : null) || this._defaults.dayNames, p = (e ? e.monthNamesShort : null) || this._defaults.monthNamesShort, g = (e ? e.monthNames : null) || this._defaults.monthNames, _ = -1, f = -1, k = -1, D = -1, m = !1, y = function(e) {
                ...
                if (m)
                    ...
                    case "y":
                        ...
                        break;
                    case "@":
                        _ = (o = new Date(a("@"))).getFullYear(),
                        f = o.getMonth() + 1,
                        k = o.getDate();
                        break;
                    case "!":
                        _ = (o = new Date((a("!") - this._ticksTo1970) / 1e4)).getFullYear(),
                        f = o.getMonth() + 1,
                        k = o.getDate();
                        break;
                    case "'":
            ...
            if (c < s.length && (d = s.substr(c),
            !/^\s+/.test(d)))
                throw "Extra/unparsed characters found in date: " + d;
            if (-1 === _ ? _ = (new Date).getFullYear() : _ < 100 && (_ += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (_ <= l ? 0 : -100)),
            -1 < D)
                for (f = 1,
                k = D; ; ) {
                    if (k <= (r = this._getDaysInMonth(_, f - 1)))
                        break;
                    f++,
                    k -= r
                }
            if ((o = this._daylightSavingAdjust(new Date(_,f - 1,k))).getFullYear() !== _ || o.getMonth() + 1 !== f || o.getDate() !== k)
                throw "Invalid date";
            return o
        },
        ATOM: "yy-mm-dd",
        ...
        formatDate: function(t, e, a) {
            ...
            var n, r = (a ? a.dayNamesShort : null) || this._defaults.dayNamesShort, d = (a ? a.dayNames : null) || this._defaults.dayNames, o = (a ? a.monthNamesShort : null) || this._defaults.monthNamesShort, c = (a ? a.monthNames : null) || this._defaults.monthNames, l = function(e) {
        ...
        _generateHTML: function(e) {
            var t, a, i, s, n, r, d, o, c, l, h, u, p, g, _, f, k, D, m, y, v, M, b, w, C, I, x, Y, S, N, F, T, A = new Date, K = this._daylightSavingAdjust(new Date(A.getFullYear(),A.getMonth(),A.getDate())), j = this._get(e, "isRTL"), O = this._get(e, "showButtonPanel"), E = this._get(e, "hideIfNoPrevNext"), R = this._get(e, "navigationAsDateFormat"), P = this._getNumberOfMonths(e), L = this._get(e, "showCurrentAtPos"), A = this._get(e, "stepMonths"), W = 1 !== P[0] || 1 !== P[1], H = this._daylightSavingAdjust(e.currentDay ? new Date(e.currentYear,e.currentMonth,e.currentDay) : new Date(9999,9,9)), U = this._getMinMaxDate(e, "min"), z = this._getMinMaxDate(e, "max"), B = e.drawMonth - L, J = e.drawYear;
            if (B < 0 && (B += 12,
            J--),
            z)
                for (t = this._daylightSavingAdjust(new Date(z.getFullYear(),z.getMonth() - P[0] * P[1] + 1,z.getDate())),
                t = U && t < U ? U : t; this._daylightSavingAdjust(new Date(J,B,1)) > t; )
                    --B < 0 && (B = 11,
                    J--);
            for (e.drawMonth = B,
            e.drawYear = J,
            L = this._get(e, "prevText"),
            L = R ? this.formatDate(L, this._daylightSavingAdjust(new Date(J,B - A,1)), this._getFormatConfig(e)) : L,
            a = this._canAdjustMonth(e, -1, J, B) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + L + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "e" : "w") + "'>" + L + "</span></a>" : E ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + L + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "e" : "w") + "'>" + L + "</span></a>",
            L = this._get(e, "nextText"),
            L = R ? this.formatDate(L, this._daylightSavingAdjust(new Date(J,B + A,1)), this._getFormatConfig(e)) : L,
            i = this._canAdjustMonth(e, 1, J, B) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + L + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "w" : "e") + "'>" + L + "</span></a>" : E ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + L + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "w" : "e") + "'>" + L + "</span></a>",
            E = this._get(e, "currentText"),
            L = this._get(e, "gotoCurrent") && e.currentDay ? H : K,
            E = R ? this.formatDate(E, L, this._getFormatConfig(e)) : E,
            R = e.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(e, "closeText") + "</button>",
            R = O ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (j ? R : "") + (this._isInRange(e, L) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + E + "</button>" : "") + (j ? "" : R) + "</div>" : "",
            ...
            f = 0; f < P[0]; f++) {
                ...
                D = 0; D < P[1]; D++) {
                    ...
                    C = Math.ceil((w + C) / 7),
                    I = W && this.maxRows > C ? this.maxRows : C,
                    this.maxRows = I,
                    ...
                    Y = 0; Y < I; Y++) {
                        ...
                        _ = 0; _ < 7; _++)
                            ...
                            S += "<td class='" + (5 <= (_ + s + 6) % 7 ? " ui-datepicker-week-end" : "") + (F ? " ui-datepicker-other-month" : "") + (x.getTime() === m.getTime() && B === e.selectedMonth && e._keyEvent || p.getTime() === x.getTime() && p.getTime() === m.getTime() ? " " + this._dayOverClass : "") + (T ? " " + this._unselectableClass + " ui-state-disabled" : "") + (F && !h ? "" : " " + N[1] + (x.getTime() === H.getTime() ? " " + this._currentClass : "") + (x.getTime() === K.getTime() ? " ui-datepicker-today" : "")) + "'" + (F && !h || !N[2] ? "" : " title='" + N[2].replace(/'/g, "&#39;") + "'") + (T ? "" : " data-handler='selectDay' data-event='click' data-month='" + x.getMonth() + "' data-year='" + x.getFullYear() + "'") + ">" + (F && !h ? "&#xa0;" : T ? "<span class='ui-state-default'>" + x.getDate() + "</span>" : "<a class='ui-state-default" + (x.getTime() === K.getTime() ? " ui-state-highlight" : "") + (x.getTime() === H.getTime() ? " ui-state-active" : "") + (F ? " ui-priority-secondary" : "") + "' href='#'>" + x.getDate() + "</a>") + "</td>",
                    ...
                    11 < ++B && (B = 0,
                    J++),
                    k += v += "</tbody></table>" + (W ? "</div>" + (0 < P[0] && D === P[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")
                }
                g += k
            }
            return g += R,
