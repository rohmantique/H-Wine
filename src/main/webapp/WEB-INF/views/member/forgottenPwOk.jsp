...
<body>
    ...
    <form action="https://www.winenara.com/shop/login" id="LoginPostFrm" onkeydown="javascript:onEnterLogin();"
        ...
        <input type="hidden" name="witplus_csrf_token" value="013538a8c666f98c06e41cd2804f2a15">
    ...
    <section id="contents" style="margin-top: 122px;">
        <div class="lnb event_lnb lnb_wrap">
            <div class="pc_hidden">
                ...
                <div class="select_brand js_select" id="select_brand">
                    <button type="button" class="my_value js_selectBtn" onclick="$(this).toggleClass('on')"><span>비밀번호
                            재발급</span></button>
        ...
        <div class="wrap">
            <div class="content member forgoten_pw_ok_page">
                <div class="top_txt">
                    <p>차민수님 임시 비밀번호를<br>등록하신 연락처로 발송하였습니다.</p>
                </div>
                <div class="btn_area col2">
                    <button type="button" class="btn_txt" onclick="location.href='/shop/main'"><span>홈으로
                            이동</span></button>
                    <button type="button" class="btn_txt btn_black"
                        onclick="commonUI.layer.open('login_layer')"><span>로그인</span></button>
                </div>
            </div>
        </div>
