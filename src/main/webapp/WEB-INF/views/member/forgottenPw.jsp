...
<body>
    ...
    <form action="https://www.winenara.com/shop/login" id="LoginPostFrm" onkeydown="javascript:onEnterLogin();"
        ...
        <input type="hidden" name="witplus_csrf_token" value="919759751f29843748de0d831460ccd8">
    ...
    <section id="contents" style="margin-top: 122px;">
        ...
        <div class="wrap">
            <div class="content member forgoten_pw_page">
                ...
                <div class="form_area">
                    <form action="https://www.winenara.com/shop/member/forgoten/forgoten_pw_ok" name="find_form"
                ...
                <div class="btn_area">
                    <button type="button" class="btn_txt btn_black" onclick="find_submit()"><span>비밀번호
                            재발급</span></button>
                </div>
            </div>
        </div>
