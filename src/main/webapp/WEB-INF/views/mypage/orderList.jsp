...
<body>
	...
	<script type="text/javascript">
		...
		function displayOrderList(orders) {
            ...
            if (orders.length == 0) {
            	nodata += `
					<div class="empty" id="nodata" style="margin-bottom: 50px;">
                    	<p>주문 내역이 없습니다.</p>
               		</div>
               			`;
            	$(".orderList").append(nodata);
			} 
    				...
    				str+=`
    					...
    					<div class="box con" style="padding-left: 5px;">
    						<div class="more_info">
    							...
    							</span> <span class="label" style="background: #46675c;padding-top: 5px;padding-bottom: 5px;">품종 :
    									\${item.productDetail.wv_variety_kor}
    							</span><span class="label"
    								style="background: #46675c;padding-top: 5px;padding-bottom: 5px;margin-left: 3px;">타입 :
