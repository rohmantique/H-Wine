...
<body>
	<form action="https://www.winenara.com/shop/login" id="LoginPostFrm"
		...
		<input type="hidden" name="witplus_csrf_token"
			value="190bbb6df5b90cafabf5904d58391df4">
									...
									<li>
										<div class="form_box">
											<input type="text" id="login_user_id" name="login_user_id"
												value="qndjd711" placeholder="아이디를 입력하세요">
										</div>
									</li>
									<li>
										<div class="form_box">
							...
							<div class="save_box">
								...
								<div class="checkbox">
									<input type="checkbox" name="id_save" id="id_save" value="Y"
										checked=""> <label for="id_save">아이디저장</label>
								</div>
			...
			<div class="pc_hidden">
				...
				<div class="select_brand js_select" id="select_brand">
					...
					<ul class="mb_lnb_lists">
						...
						<li><a href="/shop/mypage/tabling">테이블링 내역</a></li>
	...
	<script type="text/JavaScript">
		...
		if (page !== 'product_view' && page !== 'order_ok') {
			...
			/*
				RC_Method({
					sign_up_data: "2023-03-02 11:39:55",
					page_type : page, 
					behavior:"page_view"
				});
			 */
